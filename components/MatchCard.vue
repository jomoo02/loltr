<template>
    <div class="w-full h-full rounded-lg flex px-0.5 flex-col lg:flex-row" :class="inputSummoner.win ? 'container_win' : 'container_loss'">
        <div class="flex items-center lg:items-start lg:flex-col  justify-between lg:gap-x-0 lg:justify-center border-b lg:border-b-0 lg:border-r w-auto lg:w-[7.5rem] xl:w-[7.5rem] px-3 md:px-6 lg:px-4 xl:px-5 gap-y-1 py-0.5 lg:py-0" :class="inputSummoner.win ? 'border_win' : 'border_loss'">
            ...
            <div class="flex lg:flex-col gap-x-2 lg:gap-x-0">
        ...
        <div class="w-full flex px-3 lg:px-0 h-full items-center">
            <!-- 챔프, 스펠, 룬, cs, 아이템 -->
            <div class="flex h-full w-full lg:w-auto">
                <div class="flex md:flex-row w-full lg:w-auto h-full items-center">
                    <div class="flex md:flex-col justify-between md:justify-center h-full w-full gap-1 md:gap-2 lg:border-r md:pl-6 items-center md:items-start md:w-[17rem] lg:w-[18.5rem] xl:w-[18.5rem]  md:gap-x-0" :class="inputSummoner.win ? 'border_win' : 'border_loss'">
                        ...
                        <div class="flex gap-x-[2px] pt-1 md:pt-0">
                            <div class="flex flex-col md:flex-row gap-x-[2px] gap-y-[2.5px] md:gap-y-0">
                ...
                <!-- << tablet: cs -->
                <div class="w-32 lg:w-20 xl:w-24 h-full lg:justify-center lg:px-1 hidden md:flex" >
            ...
            <!-- 플레이어 -->
            <div class="hidden md:flex gap-4 lg:w-[21rem] xl:w-[17rem]  justify-center lg:justify-around xl:justify-center items-center px-3 lg:px-6 lg:border-l h-full" :class="inputSummoner.win ? 'border_win' : 'border_loss'">
                <!-- 블루팀 -->
