<template>
    <div class="flex flex-col">
        <!-- info -->
        <div class="hidden lg:flex justify-between text-sm text-gray-500 border-b xs:px-2 sm:px-5 lg:px-6 xl:px-2 py-0.5 bg-white border-t border-t-inherit"
        ...
        >
            <div class="flex">
                ...
                <div class="w-[6rem] xl:w-[5.25rem] flex justify-center">KDA</div>
            </div>
            <div class="flex">
        ...
        <div v-for="(participant, index) in participants" :key="index" 
            ...
            :class="{ 'bg-slate-400/25': redo, 'bg-win/20': win, 'bg-loss/20': loss, 'bg-win/40': win && puuid === participant.puuid, 'bg-loss/40': loss && puuid === participant.puuid, 'last:rounded-b-md': team === '레드팀' }"
        >
